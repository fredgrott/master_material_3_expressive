...
class MainSettingsButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const fadeThroughShuttle = FadeThroughShuttleBuilder(
      fadeColor: CupertinoColors.extraLightBackgroundGray,
    );

    const chained = ChainedShuttleBuilder(builders: [
      FlipShuttleBuilder(),
      fadeThroughShuttle,
      FadeShuttleBuilder(),
    ]);
    return PullDownButton(
      itemBuilder: (context) => [
        const PullDownMenuTitle(title: Text('Select Spring')),
        PullDownMenuItem.selectable(
          onTap: () => springNotifier.value = const CupertinoMotion.bouncy(),
          title: 'Bouncy',
          selected: springNotifier.value == const CupertinoMotion.bouncy(),
        ),
        PullDownMenuItem.selectable(
          onTap: () => springNotifier.value = const CupertinoMotion.snappy(),
          title: 'Snappy',
          selected: springNotifier.value == const CupertinoMotion.snappy(),
        ),
        PullDownMenuItem.selectable(
          onTap: () => springNotifier.value = const CupertinoMotion.smooth(),
          title: 'Smooth',
          selected: springNotifier.value == const CupertinoMotion.smooth(),
        ),
        PullDownMenuItem.selectable(
          onTap: () => springNotifier.value = const CupertinoMotion.interactive(),
          title: 'Interactive',
          subtitle: 'Too fast - janky',
          icon: CupertinoIcons.exclamationmark_triangle,
          selected: springNotifier.value == const CupertinoMotion.interactive(),
        ),
        const PullDownMenuTitle(title: Text('Flight Shuttle Animation')),
        PullDownMenuItem.selectable(
        ...
        const PullDownMenuTitle(title: Text('Timing')),
        PullDownMenuItem.selectable(
...
class DetailsPageSettingsButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PullDownButton(
      itemBuilder: (context) => [
        const PullDownMenuTitle(title: Text('Aspect Ratio')),
