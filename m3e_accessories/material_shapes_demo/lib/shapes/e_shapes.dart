...
import 'package:material_shapes_demo/shapes/corner_rounding.dart';
...
abstract final class MaterialShapes {
  ...
  static final RoundedPolygon oval = RoundedPolygon.circle()
      .transformed(
        (Matrix4.identity()
              ...
              ..scaleByVector3(Vector3(0,1.0, 0.64,)))
            .asPointTransformer(),
      )
      .normalized();
  ...
  static final RoundedPolygon puffy =
      _customPolygon(
          ...
          .transformed(
            (Matrix4.identity()..scaleByVector3(Vector3(0,1.0, 0.742))).asPointTransformer(),
          )
          .normalized();
