      ...
      child: Wrap(
        ...
        children: [
          FloatingActionButton.small(
            onPressed: () {},
            tooltip: 'Small',
            child: const Icon(Symbols.add_task),
          ),
...
const List<NavigationDestination> appBarDestinations = [
  NavigationDestination(
    tooltip: '',
    icon: Icon(Symbols.widget_medium),
    label: 'Components',
  ...
  NavigationDestination(
    tooltip: '',
    icon: Icon(Symbols.invert_colors),
    label: 'Elevation',
...
const List<Widget> exampleBarDestinations = [
  ...
  NavigationDestination(
    tooltip: '',
    icon: Icon(Symbols.pets_rounded),
    label: 'Pets',
    selectedIcon: Icon(Symbols.pets),
  ),
  NavigationDestination(
    tooltip: '',
    icon: Icon(Symbols.account_box_rounded),
    label: 'Account',
...
List<Widget> barWithBadgeDestinations = [
  NavigationDestination(
    tooltip: '',
    icon: Badge.count(count: 1000, child: const Icon(Symbols.mail_rounded)),
    label: 'Mail',
  ...
  const NavigationDestination(
    tooltip: '',
    icon: Badge(child: Icon(Symbols.group_off_rounded)),
    label: 'Rooms',
    selectedIcon: Badge(child: Icon(Symbols.group_rounded)),
  ),
  NavigationDestination(
    tooltip: '',
    icon: Badge.count(count: 3, child: const Icon(Symbols.videocam_rounded)),
    label: 'Meet',
    selectedIcon: Badge.count(count: 3, child: const Icon(Symbols.videocam)),
  ),
];
...
class _BottomSheetSectionState extends State<BottomSheetSection> {
  ...
  Widget build(BuildContext context) {
    List<Widget> buttonList = <Widget>[
      IconButton(onPressed: () {}, icon: const Icon(Symbols.share_rounded)),
      IconButton(onPressed: () {}, icon: const Icon(Symbols.add)),
      IconButton(onPressed: () {}, icon: const Icon(Symbols.delete_outline)),
      IconButton(onPressed: () {}, icon: const Icon(Symbols.archive_rounded)),
      IconButton(onPressed: () {}, icon: const Icon(Symbols.settings_rounded)),
...
class ButtonAnchorExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MenuAnchor(
      ...
      menuChildren: [
        MenuItemButton(
          leadingIcon: const Icon(Symbols.people_alt_rounded),
...
const List<ExampleDestination> destinations = <ExampleDestination>[
  ExampleDestination('Inbox', Icon(Symbols.inbox_rounded), Icon(Symbols.inbox)),
  ExampleDestination('Outbox', Icon(Symbols.send_rounded), Icon(Symbols.send)),
  ExampleDestination(
    'Favorites',
    Icon(Icons.favorite_outline),
    Icon(Icons.favorite),
  ),
  ExampleDestination('Trash', Icon(Symbols.delete_outline), Icon(Symbols.delete)),
];
        ...
        child: Scaffold(
          appBar: AppBar(
            bottom: TabBar(
              ...
              tabs: const <Widget>[
                Tab(
                  icon: Icon(Symbols.videocam_rounded),
                  text: 'Video',
                  iconMargin: EdgeInsets.only(bottom: 0.0),
                ),
                Tab(
                  icon: Icon(Symbols.photo_rounded),
                  text: 'Photos',
                  iconMargin: EdgeInsets.only(bottom: 0.0),
                ),
                Tab(
...
class TopAppBars extends StatelessWidget {
  ...
  static final actions = [
    IconButton(icon: const Icon(Symbols.attach_file), onPressed: () {}),
    IconButton(icon: const Icon(Symbols.event), onPressed: () {}),
    IconButton(icon: const Icon(Symbols.more_vert), onPressed: () {}),
  ];
...
enum IconLabel {
  smile('Smile', Symbols.sentiment_satisfied_rounded),
  cloud('Cloud', Symbols.cloud_rounded),
  brush('Brush', Symbols.brush_rounded),
