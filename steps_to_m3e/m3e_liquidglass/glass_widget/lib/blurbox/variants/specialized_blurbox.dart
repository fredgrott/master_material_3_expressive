...
class RadialBlurPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final center = Offset(size.width * (focalPoint.x * 0.5 + 0.5), size.height * (focalPoint.y * 0.5 + 0.5));
    ...
    for (int i = quality; i > 0; i--) {
      ...
      final blurPaint = Paint()
        ..imageFilter = ui.ImageFilter.blur(sigmaX: currentBlur, sigmaY: currentBlur, tileMode: TileMode.decal)
