...
import 'package:glass_widget/blurbox/interfaces/blur_properties.dart';
...
class PatternedBlurBox extends StatelessWidget implements BlurProperties, BoxProperties {
            ...
            if (patternAsset != null || patternUrl != null)
              Positioned.fill(
                child: Opacity(
                  ...
                  child: ClipRRect(borderRadius: borderRadius, child: _buildPatternLayer()),
                ),
              ),
  ...
  Widget _buildPatternLayer() {
    ...
    if (patternScale != 1.0) {
      patternWidget = Transform.scale(scale: patternScale, child: patternWidget);
    }
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: patternAsset != null ? AssetImage(patternAsset!) : NetworkImage(patternUrl!) as ImageProvider,
                  repeat: ImageRepeat.repeat,
                  scale: 1 / patternScale,
                  colorFilter: patternColor != null ? ColorFilter.mode(patternColor!, patternBlendMode) : null,
                  alignment: patternAlignment,
                ),
              ),
            ),
