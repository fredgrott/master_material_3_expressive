...
/// When Icons was switched to Material Symbol varaible font we also got the
/// abiiity to use grade changes to affect the icon thickness. This aspect is used in
/// Icon fill animation In Material Expressive.
library;
...
abstract final class IconGrade {
  ...
  static double of(BuildContext context) => switch (Theme.brightnessOf(context)) {
