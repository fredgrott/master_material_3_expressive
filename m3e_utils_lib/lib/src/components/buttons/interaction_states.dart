  ...
  WidgetStateMapper<Color?> get _mapper {
    ...
    return WidgetStateMapper<Color?>({
      if (selectedColor != null) ...{
        WidgetState.selected & WidgetState.hovered: selectedColor.withValues(alpha: _kHoverOpacity),
        WidgetState.selected & WidgetState.focused: selectedColor.withValues(alpha: _kFocusOpacity),
        WidgetState.selected & WidgetState.pressed: selectedColor.withValues(alpha: _kPressedOpacity),
        WidgetState.selected & WidgetState.dragged: selectedColor.withValues(alpha: _kDraggedOpacity),
      },
      if (color != null) ...{
...
class ForegroundStateOverlay implements WidgetStateProperty<Color?> {
  ...
  const ForegroundStateOverlay({required this.color, this.disabledColor, this.selectedColor});
  ...
  WidgetStateMapper<Color?> get _mapper => WidgetStateMapper<Color?>({
    WidgetState.disabled: (disabledColor ?? color)?.withValues(alpha: _kDisabledForegroundOpacity),
...
class BackgroundStateOverlay implements WidgetStateProperty<Color?> {
  ...
  const BackgroundStateOverlay({required this.color, this.disabledColor, this.selectedColor});
  ...
  WidgetStateMapper<Color?> get _mapper => WidgetStateMapper<Color?>({
    WidgetState.disabled: (disabledColor ?? color)?.withValues(alpha: _kDisabledContainerOpacity),
    if (selectedColor != null) WidgetState.selected: selectedColor,
    WidgetState.any: color,
  });
...
class OutlineStateOverlay implements WidgetStateProperty<BorderSide> {
  ...
  BorderSide resolve(Set<WidgetState> states) =>
      BorderSide(color: _mapper.resolve(states), width: WidgetStateMapper(borderWidthResolver).resolve(states));
}
