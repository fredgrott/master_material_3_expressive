...
import 'package:m3e_utils_lib/src/components/buttons/interaction_states.dart';
...
final class M3ButtonStyle extends ButtonStyle {
  ...
  M3ButtonStyle({
    ...
    super.foregroundBuilder,
         ...
         overlayColor: InteractionStatesOverlay(color: foregroundColor, selectedColor: selectedColor),
  ...
  /// <https://m3.material.io/components/buttons/specs#bff80ee9-28fb-41a0-a671-0ab29ffc04d5>
  static const textButtonIconLayoutPadding = EdgeInsets.only(left: 12, right: 16);

  /// Helper method used to scale [M3ButtonStyle].**Padding values.
  static EdgeInsetsGeometry scaledPaddingOf(BuildContext context, EdgeInsets padding) {
    const kFontSize = 14.0;
    final TextTheme theme = Theme.of(context).textTheme;
    final double defaultFontSize = theme.labelLarge?.fontSize ?? kFontSize;
    final double effectiveTextScale = MediaQuery.textScalerOf(context).scale(defaultFontSize) / kFontSize;
